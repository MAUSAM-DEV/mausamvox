  ...
  return (
    <div className="sh-shell">
      ...
      <main className="sh-main">
        ...
        {state === 'ready' && meta && (
          <div className="sh-card">
            ...
            <p className="sh-foot">
              Made with <Link href="/" style={{ color: '#8B5CF6', textDecoration: 'none', fontWeight: 600 }}>MausamVox</Link> —
      ...
      <style suppressHydrationWarning>{`
        ...
        .sh-note { text-align: center; padding: 80px 0; font-size: 13px; color: #5A5A80; }
        .sh-card {
        ...
        .sh-sub { font-size: 13px; color: #7878A0; margin-bottom: 20px; }
        ...
        .sh-cta:hover { box-shadow: 0 8px 24px rgba(139,92,246,.4); transform: translateY(-1px); }
        .sh-foot { font-size: 12px; color: #5A5A80; line-height: 1.6; margin: 18px 0 0; }

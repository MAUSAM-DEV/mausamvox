...
const features = [
  ...
  },
  {
    ...
    desc: '6-stem separation using BS-RoFormer (world\'s top vocal model) + HTDemucs. BPM and key detection. In-browser per-stem editing. Smart file naming.',
    tag: '6 Stems · BS-RoFormer',
    tagType: 'c',
  },
  {
    icon: '🎼',

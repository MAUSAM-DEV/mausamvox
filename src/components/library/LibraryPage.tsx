  ...
  return (
    <>
      ...
      <style suppressHydrationWarning>{`
        ...
        .lib-head {
          padding: 18px 40px; border-bottom: 1px solid #1E1E3A;
          display: flex; align-items: center; justify-content: space-between;
        }
        .lib-back { font-size: 13px; font-weight: 600; color: #7878A0; text-decoration: none; transition: color 0.2s; }
        ...
        .lib-sub { font-size: 13px; color: #7878A0; line-height: 1.7; margin: 0 0 24px; max-width: 640px; }
        ...
        .lib-search:focus { border-color: #8B5CF6; }
        .lib-search::placeholder { color: #4A4A6A; }
        .lib-lang {
          background: #0D0D22; border: 1px solid #2A2A4A; border-radius: 9px;
          padding: 11px 14px; color: #F0F0FF; font-size: 13px;
          font-family: Inter, sans-serif; outline: none; cursor: pointer;
        }
        .lib-note { text-align: center; padding: 48px 0; font-size: 13px; color: #5A5A80; }
        .lib-empty {
        ...
        .lib-empty-txt { font-size: 13px; color: #7878A0; line-height: 1.7; max-width: 380px; margin: 0 auto 22px; }
        .lib-btn-solid {
        ...
        .lib-btn-solid:hover { box-shadow: 0 8px 24px rgba(139,92,246,.4); transform: translateY(-1px); }
        .lib-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 12px; }
        .lib-card {
          background: #09091A; border: 1px solid #1E1E3A; border-radius: 14px;
          padding: 18px; display: flex; flex-direction: column; gap: 10px;
          transition: border-color 0.2s;
        }
        .lib-card:hover { border-color: rgba(139,92,246,.35); }
        ...
        .lib-tag {
          ...
          background: rgba(6,182,212,.08); color: #06B6D4; border: 1px solid rgba(6,182,212,.18);
        }
        .lib-card-bio { font-size: 12px; color: #7878A0; line-height: 1.6; margin: 0; }
        ...
        .lib-btn-ghost:hover { border-color: #8B5CF6; color: #8B5CF6; }
        .lib-btn-use {
          margin-left: auto; font-size: 12px; font-weight: 600; color: #8B5CF6;
          text-decoration: none; transition: color 0.2s;
        }
        .lib-btn-use:hover { color: #EC4899; }
        .lib-foot-note { font-size: 12px; color: #5A5A80; line-height: 1.6; margin-top: 28px; text-align: center; }

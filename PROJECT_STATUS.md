...
| Fine-tune panel (RVC params) | ✅ Working | Adjustable protect / index_rate / filter_radius / rms_mix_rate w/ 30s preview; "Reset to defaults" button restores all sliders in one click |
